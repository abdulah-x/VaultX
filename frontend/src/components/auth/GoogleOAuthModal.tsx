...
export default function GoogleOAuthModal({ isOpen, onClose, onSuccess, context = 'signup' }: GoogleOAuthModalProps) {
 ...
 <div className="relative w-full max-w-md bg-background border border-border rounded-2xl shadow-2xl p-6">
 {/* Close Button */}
 <button
 onClick={onClose}
 ...
 {/* Error Message */}
 {error && (
 <div className="mb-4 p-3 bg-vaultx-danger/20 border border-vaultx-danger/40 rounded-lg text-vaultx-danger text-sm">
 {error}
 </div>
 )}
